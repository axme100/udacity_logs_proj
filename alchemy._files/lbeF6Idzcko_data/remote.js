...
this.g=0;this.B=a;this.D=[];this.C=new g.UB;this.A=this.o=null;this.I=(0,g.z)(this.bO,this);this.F=(0,g.z)(this.ql,this);this.G=(0,g.z)(this.aO,this);this.J=(0,g.z)(this.oO,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.ku,this),tAa(this))):c=3;0!=c&&(b?this.ku(c):g.fF((0,g.z)(function(){this.ku(c)},this),0));
var d=pAa();d&&d8(this,d);this.subscribe("yt-remote-cast2-session-change",this.J)},f8=function(a){return new g.XI(a.B.getPlayerContextData())},tAa=function(a){(0,g.G)("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange".split(" "),function(a){this.D.push(this.B.subscribe(a,g.Da(this.sQ,a),this))},a)},uAa=function(a){(0,g.G)(a.D,function(a){this.B.unsubscribeByKey(a)},a);
...
a.B.setPlayerContextData(g.cJ(b));tAa(a)},d8=function(a,b){a.A&&(a.A.removeUpdateListener(a.I),a.A.removeMediaListener(a.F),a.ql(null));
a.A=b;a.A&&(k8("Setting cast session: "+a.A.sessionId),a.A.addUpdateListener(a.I),a.A.addMediaListener(a.F),a.A.media.length&&a.ql(a.A.media[0]))},vAa=function(a){var b=a.o.media,c=a.o.customData;
...
this.cd=a;this.o=[];this.o.push(this.cd.$_s("screenChange",(0,g.z)(this.GT,this)));this.o.push(this.cd.$_s("onlineScreenChange",(0,g.z)(this.YP,this)))},n8=function(){return g.x("yt.mdx.remote.currentScreenId_")},o8=function(a){g.QH("remote",a)},p8=function(a){g.ua("yt.mdx.remote.connectData_",a,void 0)},q8=function(){return g.x("yt.mdx.remote.channelParams_")||{}},wAa=function(){var a=q8();
...
this.D=null!=c?(0,g.z)(a,c):a;this.qc=b;this.C=(0,g.z)(this.vH,this);this.g=!1;this.o=0;this.A=this.Aa=null;this.B=[]},F8=function(a,b,c){g.L.call(this);
this.F=a;this.R=b;this.o=new g.EG(this);g.M(this,this.o);this.o.P(b,"onCaptionsTrackListChanged",this.rP);this.o.P(b,"captionschanged",this.ZN);this.o.P(b,"captionssettingschanged",this.lC);this.o.P(b,"videoplayerreset",this.qo);this.o.P(b,"mdxautoplaycancel",this.DG);this.O=this.o.P(b,"onVolumeChange",this.BA);this.D=!1;this.g=c;c.subscribe("proxyStateChange",this.OA,this);c.subscribe("remotePlayerChange",this.sl,this);c.subscribe("remoteQueueChange",this.qo,this);c.subscribe("autoplayUpNext",this.oA,
this);c.subscribe("previousNextChange",this.LA,this);c.subscribe("nowAutoplaying",this.DA,this);c.subscribe("autoplayDismissed",this.nA,this);this.suggestion=null;this.G=new g.lR(64);this.A=new g.It(this.gC,500,this);g.M(this,this.A);this.B=new g.It(this.hC,1E3,this);g.M(this,this.B);this.J=new E8(this.eT,0,this);g.M(this,this.J);this.C={};this.L=new g.It(this.KC,1E3,this);g.M(this,this.L);this.I=new g.Dk(this.MK,1E3,this);g.M(this,this.I);this.N=g.y;this.lC();this.qo();this.sl()},G8=function(a,b){var c=
...
b&&(c={style:a.R.mi()},g.dc(c,b));a.g.YB(a.R.ga(1).videoId,c);a.C=f8(a.g).o}},K8=function(a,b){var c=a.R.Sf();
if(c){var d=c.be();var e=c.listId.toString()}var f=a.R.ga(1);c=a.g;var k=f.videoId,l=d;d=f.playerParams;f=f.oj;var m=f8(c),n=e||m.listId;l=l||0;var q={videoId:k,currentIndex:l};g.bJ(m,k,l);g.t(b)&&(g.$I(m,b),q.currentTime=b);g.t(n)&&(q.listId=n);null!=d&&(q.playerParams=d);null!=f&&(q.clickTrackingParams=f);j8(c,"setPlaylist",q);e||h8(c,m);H8(a,new g.lR(1))},HAa=function(a,b){if(b){var c=a.R.wc("captions","tracklist",{Vx:1});
c&&c.length?(a.R.Dd("captions","track",b),a.D=!1):(a.R.dl("captions"),a.D=!0)}else a.R.Dd("captions","track",{})},I8=function(a){return f8(a.g).videoId==a.R.ga(1).videoId},H8=function(a,b){a.B.stop();
...
g.h=eAa.prototype;g.h.Wh=function(a){var b=this.g;if(g.t(void 0)?0:this.o)b="https://"+this.domain+this.port+this.g;return g.Pg(b+a,{})};
g.h.iu=function(a,b,c,d){c={format:"JSON",method:"POST",context:this,timeout:5E3,withCredentials:!1,Tb:g.Da(this.BT,c,!0),onError:g.Da(this.AT,d),Fd:g.Da(this.CT,d)};b&&(c.Nb=b,c.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.vF(a,c)};
...
g.h.ju=function(a,b){if(1==this.g){j8(this,"setAudioTrack",{videoId:a,audioTrackId:b.Qc.id});var c=f8(this);c.audioTrackId=b.Qc.id;h8(this,c)}else g8(this,g.Da(this.ju,a,b))};
...
g.h.qw=function(){1==this.g?j8(this,"dismissAutoplay"):g8(this,this.qw)};
...
g.h.ku=function(a){if((a!=this.g||2==a)&&3!=this.g&&0!=a){var b=this.g;this.g=a;this.U("proxyStateChange",b,a);if(1==a)for(;!this.C.isEmpty();)g.XB(this.C).apply(this);else 3==a&&this.dispose()}};
g.h.sQ=function(a,b){this.U(a,b)};
g.h.bO=function(a){if(!a)this.ql(null),d8(this,null);else if(this.A.receiver.volume){a=this.A.receiver.volume;var b=f8(this),c=Math.round(100*a.level||0);if(b.volume!=c||b.muted!=a.muted)k8("Cast volume update: "+a.level+(a.muted?" muted":"")),b.volume=c,b.muted=!!a.muted,h8(this,b)}};
g.h.ql=function(a){k8("Cast media: "+!!a);this.o&&this.o.removeUpdateListener(this.G);if(this.o=a)this.o.addUpdateListener(this.G),vAa(this),this.U("remotePlayerChange")};
g.h.aO=function(a){a?(vAa(this),this.U("remotePlayerChange")):this.ql(null)};
g.h.oO=function(){var a=pAa();a&&d8(this,a)};
...
g.h.YP=function(){this.U("onlineScreenChange")};
var A8=null,y8=null,D8=[],t8=null;g.A(E8,g.L);g.h=E8.prototype;g.h.uH=function(a){this.B=arguments;this.g=!1;this.Aa?this.A=(0,g.F)()+this.qc:this.Aa=g.rg(this.C,this.qc)};
...
g.h.vH=function(){this.A?(this.Aa=g.rg(this.C,this.A-(0,g.F)()),this.A=null):(this.Aa=null,this.o?this.g=!0:(this.g=!1,this.D.apply(null,this.B)))};g.p(F8,g.L);g.h=F8.prototype;
g.h.X=function(){g.L.prototype.X.call(this);this.A.stop();this.B.stop();this.J.stop();this.N();this.g.unsubscribe("proxyStateChange",this.OA,this);this.g.unsubscribe("remotePlayerChange",this.sl,this);this.g.unsubscribe("remoteQueueChange",this.qo,this);this.g.unsubscribe("autoplayUpNext",this.oA,this);this.g.unsubscribe("previousNextChange",this.LA,this);this.g.unsubscribe("nowAutoplaying",this.DA,this);this.g.unsubscribe("autoplayDismissed",this.nA,this);this.g=this.F=null};
g.h.Wy=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(2!=this.g.g)if(I8(this)){if(1081!=f8(this.g).g||"control_seek"!=a)switch(a){case "control_toggle_play_pause":f8(this.g).jb()?this.g.pause():this.g.play();break;case "control_play":this.g.play();break;case "control_pause":this.g.pause();break;case "control_seek":this.I.cj(c[0],c[1]);break;case "control_subtitles_set_track":J8(this,c[0]);break;case "control_set_audio_track":c=c[0],I8(this)&&this.g.ju(this.R.ga(1).videoId,
c)}}else switch(a){case "control_toggle_play_pause":case "control_play":case "control_pause":c=this.R.getCurrentTime();K8(this,0==c?void 0:c);break;case "control_seek":K8(this,c[0]);break;case "control_subtitles_set_track":J8(this,c[0]);break;case "control_set_audio_track":c=c[0],I8(this)&&this.g.ju(this.R.ga(1).videoId,c)}};
g.h.ZN=function(a){this.J.uH(a)};
g.h.eT=function(a){this.Wy("control_subtitles_set_track",g.Xb(a)?null:a)};
g.h.lC=function(){var a=this.R.wc("captions","track");g.Xb(a)||J8(this,a)};
g.h.BA=function(a){if(I8(this)){this.g.unsubscribe("remotePlayerChange",this.sl,this);var b=Math.round(a.volume);a=!!a.muted;var c=f8(this.g);if(b!=c.volume||a!=c.muted)this.g.setVolume(b,a),this.L.start();this.g.subscribe("remotePlayerChange",this.sl,this)}};
g.h.rP=function(){g.Xb(this.C)||HAa(this,this.C);this.D=!1};
g.h.OA=function(a,b){this.B.stop();2==b&&this.hC()};
g.h.sl=function(){if(I8(this)){this.A.stop();var a=f8(this.g);switch(a.g){case 1081:H8(this,new g.lR(8));break;case 1:this.gC();break;case 1085:case 3:H8(this,new g.lR(9));break;case 0:H8(this,new g.lR(2));this.I.stop();G8(this,this.R.ga().lengthSeconds);break;case 1084:H8(this,new g.lR(4));break;case 2:H8(this,new g.lR(4));G8(this,g.aJ(a));break;case -1:H8(this,new g.lR(64));break;case -1E3:a={errorCode:"mdx.remoteerror",message:g.U("YTP_MDX_PLAYER_ERROR")},H8(this,new g.lR(128,a))}a=f8(this.g).o;
...
g.h.qo=function(){I8(this)||GAa(this)};
g.h.DG=function(){this.g.qw()};
g.h.oA=function(a){a&&(a=g.vF("/watch_queue_ajax",{method:"GET",Xc:{action_get_watch_queue_item:1,video_id:a},Tb:(0,g.z)(this.rR,this)}))&&(this.N=(0,g.z)(a.abort,a))};
g.h.rR=function(a,b){var c=new g.nQ({videoId:b.videoId,title:b.title,author:b.author,murlmq_webp:b.url});this.suggestion=c;this.R.U("mdxautoplayupnext",c)};
g.h.DA=function(a){(0,window.isNaN)(a)||this.R.U("mdxnowautoplaying",a)};
g.h.nA=function(){this.R.U("mdxautoplaycanceled")};
g.h.MK=function(a,b){-1==f8(this.g).g?K8(this,a):b&&this.g.VC(a)};
...
g.h.hC=function(){this.B.stop();this.A.stop();var a=this.g.B.getReconnectTimeout();2==this.g.g&&!(0,window.isNaN)(a)&&this.B.start()};g.p(L8,g.Y);L8.prototype.B=function(a){JAa(this,a.state)};g.p(M8,g.zX);g.h=M8.prototype;g.h.create=function(){FAa(g.pO(g.X(this.g)));this.D.push(g.UG("yt-remote-before-disconnect",this.VN,this));this.D.push(g.UG("yt-remote-connection-change",this.BQ,this));this.D.push(g.UG("yt-remote-receiver-availability-change",this.MA,this));this.D.push(g.UG("yt-remote-auto-connect",this.zQ,this));this.D.push(g.UG("yt-remote-receiver-resumed",this.yQ,this));this.MA()};
g.h.load=function(){this.g.Up();g.zX.prototype.load.call(this);this.C=new F8(this,this.g,this.o);var a=yAa();a=a?a.currentTime:0;var b=s8()?new e8(r8(),void 0):null;0==a&&b&&(a=g.aJ(f8(b)));0!=a&&(this.I=a||0,this.g.U("progresssync",a,void 0));IAa(this,this.F,this.F);g.K1(this.g.app,6)};
...
g.h.Wk=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];this.loaded&&this.C.Wy.apply(this.C,[].concat([a],g.pa(c)))};
